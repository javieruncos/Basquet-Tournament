...
const AdminLayout = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-[#111]">
            ...
            {/* SIDEBAR */}
            <aside className={`
                fixed md:sticky top-0 left-0 z-40 w-64 h-screen bg-black text-white p-5 border-r border-white/10 transition-transform duration-300 ease-in-out
                ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}
            `}>
                <div className="mb-10 pt-10 md:pt-25 hidden md:block">
            ...
            <main className="flex-1 p-4 md:p-8 pt-6 md:pt-30 text-white w-full overflow-hidden">
                <Outlet />
            </main>
        </div>
    );
