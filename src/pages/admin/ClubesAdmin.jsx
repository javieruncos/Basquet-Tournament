...
import { FaPlus, FaEdit, FaTrash, FaSearch, FaShieldAlt, FaMapMarkerAlt } from 'react-icons/fa';

const ClubesAdmin = () => {
    const clubes = [
        { id: 1, nombre: "Estación Experimental", siglas: "CAEE", ciudad: "Las Talitas", estadio: "El Coloso", fundacion: "1940" },
        { id: 2, nombre: "Talleres de Tafí", siglas: "TTF", ciudad: "Tafí Viejo", estadio: "La Leonera", fundacion: "1915" },
        { id: 3, nombre: "Independiente", siglas: "IND", ciudad: "San Miguel", estadio: "Estadio Rojo", fundacion: "1920" },
    ];
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-400 text-sm">Administra las instituciones, estadios y datos generales</p>
                </div>
                            ...
                            <tr key={club.id} className="hover:bg-white/5 transition-colors">
                                ...
                                <td className="p-4">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] text-amber-300 font-black">{club.siglas}</span>
                                    </div>
                                </td>
                                ...
                                <td className="p-4 font-mono text-xs text-gray-400">{club.fundacion}</td>
                                <td className="p-4">
