...
const HeroNews = ({noticias}) => {
  ...
  const resultadosRecientes = fixture?.filter((item)=> item.estado === "Finalizado").slice(0,2);
                ...
                <div className="flex flex-col gap-2 flex-1 justify-center">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="font-bold text-[10px] uppercase">{resultadosRecientes[0]?.local?.name}</span>
                    </div>
                    <span className="text-[10px] text-gray-500 font-black">{resultadosRecientes[0]?.resultado?.total.local}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        className="w-10 h-6 object-contain"
                      />
                      <span className="font-bold text-[10px] uppercase">{resultadosRecientes[0]?.visitante?.name}</span>
                    </div>
                    <span className="text-[10px] text-amber-300 font-black">{resultadosRecientes[1]?.resultado?.total.visitante}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        className="w-10 h-6 object-contain"
                      />
                      <span className="font-bold text-[10px] uppercase">{resultadosRecientes[1]?.local?.name}</span>
                    </div>
                    <span className="text-[10px] text-gray-500 font-black">{resultadosRecientes[1]?.resultado?.total.local}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        className="w-10 h-6 object-contain"
                      />
                      <span className="font-bold text-[10px] uppercase">{resultadosRecientes[1]?.visitante?.name}</span>
                    </div>
                    <span className="text-[10px] text-amber-300 font-black">{resultadosRecientes[1]?.resultado?.total.visitante}</span>
                  </div>
                </div>
