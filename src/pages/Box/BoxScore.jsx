...
const BoxScore = () => {
    const startersLocal = ["J. Pérez", "M. Rodríguez", "A. García", "L. Martínez", "C. Sánchez"];
    const startersVisit = ["R. López", "S. Ortiz", "F. Blanco", "G. Ruiz", "H. Sosa"];
    const quarters = [
                    ...
                    <tbody className="text-white">
                        {players.map((p, i) => (
                            <tr key={i} className="border-t border-white/5 hover:bg-white/5">
                                ...
                                <td className="p-4 text-center font-bold text-amber-300">{p.pts}</td>
        ...
        <div className="p-10 px-3 lg:px-10 numberFonts mt-10">
            ...
            <div className="bg-[#171717] border border-white/10 rounded-md p-6 mb-10">
                <div className="flex justify-between items-center max-w-4xl mx-auto">
                    <div className="flex flex-col items-center gap-2">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Escudo_del_Club_Estaci%C3%B3n_Experimental_Tucum%C3%A1n.svg" className="h-16 w-16 lg:h-24 lg:w-24" alt="local" />
                        <span className="text-white font-bold text-center">Est. Experimental</span>
                    </div>
                    
                    <div className="flex flex-col items-center">
                        <div className="flex items-center gap-6">
                            <span className="text-5xl lg:text-7xl font-bold text-white">85</span>
                            <span className="text-2xl text-gray-500">-</span>
                            <span className="text-5xl lg:text-7xl font-bold text-white">72</span>
                        </div>
                        <span className="text-amber-300 mt-2 uppercase tracking-widest text-sm">Finalizado</span>
                    </div>

                    <div className="flex flex-col items-center gap-2">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Escudo_del_Club_Estaci%C3%B3n_Experimental_Tucum%C3%A1n.svg" className="h-16 w-16 lg:h-24 lg:w-24" alt="visitante" />
                        <span className="text-white font-bold text-center">Talleres de Tafí</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#171717] p-6 rounded-md border border-white/10">
                    <h3 className="text-amber-300 font-bold mb-4 uppercase text-sm tracking-widest">Titulares Local</h3>
                    <ul className="text-white space-y-3">
                        {startersLocal.map((player, i) => (
                            <li key={i} className="flex items-center gap-3 border-b border-white/5 pb-2">
                ...
                {/* Info Central: Cuartos y Sede */}
                <div className="flex flex-col gap-6">
                    <div className="bg-[#171717] p-6 rounded-md border border-white/10">
                        <h3 className="text-amber-300 font-bold mb-4 uppercase text-sm tracking-widest text-center">Resultado por Cuartos</h3>
                            ...
                            <tbody className="text-center">
                                {quarters.map((q, i) => (
                                    <tr key={i} className="border-t border-white/5">
                                        <td className="py-2 font-bold text-gray-400">{q.period}</td>
                                        <td className="py-2">{q.local}</td>
                                        <td className="py-2">{q.visit}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="bg-[#171717] p-6 rounded-md border border-white/10 text-center">
                        <h3 className="text-amber-300 font-bold mb-2 uppercase text-sm tracking-widest">Sede del Encuentro</h3>
                ...
                {/* Titulares Visitante */}
                <div className="bg-[#171717] p-6 rounded-md border border-white/10">
                    <h3 className="text-amber-300 font-bold mb-4 uppercase text-sm tracking-widest">Titulares Visitante</h3>
                    <ul className="text-white space-y-3">
                        {startersVisit.map((player, i) => (
                            <li key={i} className="flex items-center gap-3 border-b border-white/5 pb-2">
