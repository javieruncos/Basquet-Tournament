      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4">
          ...
          <div className="mt-8 flex justify-center gap-4 flex-wrap">
            <Link  to={"/noticias"} className="bg-amber-400 text-black font-bold uppercase tracking-widest py-3 px-8 rounded-lg hover:bg-amber-300 transition-all duration-300 shadow-lg shadow-amber-400/20 hover:scale-105">
              Conocer el Torneo
            </Link>
            <Link
              to="/fixture"
