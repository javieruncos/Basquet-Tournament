import portada from  "../../../assets/images/portadaResults2.png"
...
const PortadaDetalle = () => {
  return (
    <div className="min-h-60 md:h-90 lg:h-120 w-full rounded-md border-gray-400/30 border bg-[#171717] relative flex flex-col">
      <img src={portada} alt="cancha"
      className="absolute inset-0 w-full h-full object-cover overflow-hidden rounded-md"
      />
      <div className="relative z-10 bg-black/60 w-full h-full overflow-hidden rounded-md flex flex-col">
      <div className="py-5 px-4 md:px-14">
        <div className="flex gap-4 items-center justify-center pt-3">
          ...
          <span className="font-bold text-lg md:text-2xl numberFonts text-white">31/12/2022</span>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-3 items-center grow px-2 md:px-4 pb-6 md:pb-0 gap-5 md:gap-10 ">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <span className="text-gray-400 mt-2 uppercase tracking-widest md:tracking-[0.5em] text-xs md:text-base numberFonts text-center">Finalizado</span>
        </div>
        <div className="flex flex-col items-center gap-2 md:gap-4 text-center">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Escudo_del_Club_Estaci%C3%B3n_Experimental_Tucum%C3%A1n.svg"
