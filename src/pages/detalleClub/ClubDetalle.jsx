...
const ClubDetalle = () => {
  return (
    <div className="">
      <div className=" h-130 w-full gap-5 bg-dark-gradient rounded-md relative border-b border-white/30 overflow-hidden">
        <img
          src={portada}
